...
export const useBTCProvider = () => {
  const { provider, accounts, getPublicKey, signMessage, getNetwork, switchNetwork, sendBitcoin } =
    useConnectProvider();
  return { provider, accounts, getPublicKey, signMessage, getNetwork, switchNetwork, sendBitcoin };
};
